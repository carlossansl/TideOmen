 ...
 * This file demonstrates how to integrate Tideomen with a web frontend
 */

// For React/Vue/Angular applications
export class TideomenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TideomenClient(provider, contractAddress);
